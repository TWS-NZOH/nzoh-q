...
# Approved users (Windows usernames)
# All users (formerly admin and approved) are now treated the same
APPROVED_USERS = ['BECOB', 'BENM', 'MIYR', 'AOV', 'JETE', 'SACW', 'KYM', 'LEWA', 'CYK', 'TWS', 'AAPO', 'BMER', 'JRAD', 'HATU', 'SPER', 'AMABA']
